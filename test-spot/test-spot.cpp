// File: test-spot.cpp
// 
// The application this file is part of is used by me
// Joachim Pileborg <arrow@pileborg.org> to learn the
// usage of the Spotify API.
...
namespace session
{
    const char *username = "jpileborg";
    const char *password = "plaoks123";
